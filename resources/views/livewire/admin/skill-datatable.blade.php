   ...
   @include('admin.layouts.badge')
                        ...
                        <td>
                            <div class="form-check form-switch m-0">
                                <input
                                    ...
                                    type="checkbox"
                                    id="status-switch-{{ $skill->id }}"
                                    wire:click="updateStatus({{ $skill->id }}, {{ $skill->status ? 0 : 1 }})"
    ...
    <div class="row mt-3">
        <div class="col-sm-12 col-md-12">
            <div class="dataTables_paginate paging_simple_numbers">
                <x-pagination :items="$skills" livewire="true" />
            </div>
        </div>
    </div>
    ...
    @if ($showDeleteModal)
        <x-modal
            ...
            <x-slot name="footer">
                ...
                <button type="button" class="btn btn-danger" wire:click="delete({{ $skillId }})">
    ...
    @if ($showBulkDeleteModal)
        <x-modal
            ...
            <p>Are you sure you want to delete <strong>{{ count($selectedIds) }}</strong> selected skill(s)? This action cannot be undone.</p>
