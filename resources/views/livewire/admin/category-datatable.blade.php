   ...
   @include('admin.layouts.badge')
        ...
        <table class="table table-striped table-bordered table-hover" style="width: 100%;">
            <thead>
                <tr>
                    ...
                    <th wire:click="sortBy('parent_id')" style="cursor: pointer;" class="user-select-none">
                        Parent Category
    ...
    <div class="row mt-3">
        <div class="col-sm-12 col-md-12">
            <div class="dataTables_paginate paging_simple_numbers">
                <x-pagination :items="$categories" livewire="true" />
            </div>
        </div>
    </div>
    ...
    @if ($showDeleteModal)
        <x-modal
            ...
            <x-slot name="footer">
                ...
                <button type="button" class="btn btn-danger" wire:click="delete({{ $categoryId }})">
    ...
    @if ($showBulkDeleteModal)
        <x-modal
            ...
            <p>Are you sure you want to delete <strong>{{ count($selectedIds) }}</strong> selected category(ies)? This action cannot be undone.</p>
