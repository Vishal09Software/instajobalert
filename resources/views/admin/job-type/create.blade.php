        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Add Job Type</h4>
            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="card-title mb-0">Create Job Type</h5>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('job-types.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf

                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="title" class="form-label">Title <span class="text-danger">*</span></label>
                                    <x-input type="text" name="title" id="title" :value="old('title')" required autofocus placeholder="Enter job type title" />
                                    @error('title')
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <x-input type="text" name="slug" id="slug" :value="old('slug')" required placeholder="Enter job type slug" />
                                    @error('slug')
                                        <small class="text-danger d-block">{{ $message }}</small>
                                    @enderror
                                </div>
