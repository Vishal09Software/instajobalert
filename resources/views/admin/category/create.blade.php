                        ...
                        <form action="{{ route('categories.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <x-input type="text" name="title" id="title" :value="old('title')" required autofocus placeholder="Enter category title" />
                                    @error('title')
                                        <small class="text-danger d-block">{{ $message }}</small>
                                    @enderror
                                </div>
                                <div class="col-md-4 mb-3">
                                    ...
                                    <x-input type="text" name="slug" id="slug" :value="old('slug')" required placeholder="Enter category slug" />
                                    @error('slug')
                                        <small class="text-danger d-block">{{ $message }}</small>
                                    @enderror
                                </div>
